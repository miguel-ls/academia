...
<head>
    ...
    .dropdown-content { display: none; position: absolute; background-color: #2c3e50; min-width: 200px; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); z-index: 1; border-radius: 4px; padding: 5px 0; }
...
<body>
    <?php if (isset($_SESSION['user_id'])): // Condición principal para mostrar el header ?>
    <header>
        <nav>
    ...
    <?php endif; // Fin de la condición principal ?>
    <main>
