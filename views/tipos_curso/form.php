...
$page_title = $is_edit ? 'Editar Tipo de Curso' : 'Nuevo Tipo de Curso';
$action_url = $is_edit ? 'index.php?view=tipos_curso&action=update' : 'index.php?view=tipos_curso&action=create';
?>
...
<div class="form-container" style="max-width: 600px;">
    <form action="<?php echo $action_url; ?>" method="POST">
        ...
        <?php if ($is_edit): ?>
            <input type="hidden" name="id_tipo_curso" value="<?php echo $item_a_editar['id_tipo_curso']; ?>">
        <?php endif; ?>
