...
class Database {
    ...
    private function __construct() {
        ...
        $options = [
            ...
            // Sin esto, rowCount() en un UPDATE devuelve 0 cuando el valor grabado
            // es igual al existente, aunque la fila sí fue encontrada/afectada.
    ...
    public function callStoredProcedure($procedure, $params = []) {
        ...
        try {
            ...
            $this->error = $e->getMessage();
            // Se relanza para que el código que llama pueda capturarla y mostrar un mensaje amigable.
