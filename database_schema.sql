...
INSERT INTO `roles` (`id_rol`, `nombre_rol`, `descripcion`) VALUES (1, 'Administrador', 'Acceso total al sistema');
INSERT INTO `roles` (`id_rol`, `nombre_rol`, `descripcion`) VALUES (2, 'Usuario', 'Acceso limitado a operaciones');

INSERT INTO `usuarios` (`id_rol`, `nombre_usuario`, `password_hash`, `email`, `nombre_completo`) VALUES (1, 'admin', '$2y$10$t/iagDSBOSf1d2YhA.Lzce4jK2jaxtfr5QyCoLGgUoM5a9WprgI.q', 'admin@example.com', 'Administrador del Sistema'); -- la clave es "123456"

INSERT INTO `tipos_documento` (`descripcion`, `longitud`, `codigo_sunat`) VALUES ('DNI', 8, '1'), ('Pasaporte', 12, '7'), ('Carnet de Extranjería', 12, '4');
INSERT INTO `formas_pago` (`nombre`) VALUES ('Efectivo'), ('Tarjeta de Crédito/Débito'), ('Transferencia Bancaria'), ('Yape/Plin');
INSERT INTO `tipos_area` (`nombre`) VALUES ('Grande'), ('Mediana'), ('Pequeña'), ('Otro');
INSERT INTO `tipos_curso` (`nombre`) VALUES ('Taller'), ('Curso Regular'), ('Seminario');
INSERT INTO `tipos_precio` (`nombre`) VALUES ('Precio Regular'), ('Precio de Lanzamiento'), ('Precio Corporativo');
