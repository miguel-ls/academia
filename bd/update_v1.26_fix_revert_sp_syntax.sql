-- =================================================================
-- Script de Actualización de la Base de Datos - Versión 1.26
-- Corrige un error de sintaxis en el SP `sp_matricula_revertir_anulacion`.
-- =================================================================
...
-- Corrige la forma en que se construye el mensaje de error dinámico
-- para evitar problemas de interpretación del parser de MySQL.
-- -----------------------------------------------------
