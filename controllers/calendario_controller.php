...
foreach ($cursos_activos as $curso) {
    ...
    // La asistencia del alumno es la fuente de verdad del cronograma.
    $start_datetime = $curso['fecha_clase'] . 'T' . $curso['hora_inicio'];
    $end_datetime = $curso['fecha_clase'] . 'T' . $curso['hora_fin'];
