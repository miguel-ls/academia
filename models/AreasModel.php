...
class AreasModel {
    ...
    public function buscar($term) {
        $this->db->callStoredProcedure('sp_areas_buscar', [$term]);
        return $this->db->resultSet();
    }
    ...
    public function crear($datos) {
        try {
            ...
            $this->db->callStoredProcedure('sp_areas_crear', $params);
            return ['success' => true];
        } catch (Exception $e) {
    ...
    public function actualizar($datos) {
        try {
            $params = [$datos['id_area'], $datos['id_tipo_area'], $datos['nombre']];
            $this->db->callStoredProcedure('sp_areas_actualizar', $params);
    ...
    public function eliminar($id) {
        try {
            ...
            if (strpos($e->getMessage(), 'foreign key constraint') !== false) {
                 return ['success' => false, 'error' => 'No se puede eliminar el área porque está en uso en sub-áreas.'];
            }
            return ['success' => false, 'error' => $e->getMessage()];
        }
    }
    ...
    public function verificarDependencias($id) {
        $this->db->callStoredProcedure('sp_areas_verificar_dependencias', [$id]);
